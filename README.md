...
![vue-scrolling-ul](https://img.shields.io/badge/vue--scrolling--ul-v1.1.6-%23C50008?logo=npm)
...
> 这是一个 Vue 组件，提供一个自动滚动的 ul 列表。This is a Vue component that provides a list of ul that scrolls automatically.
